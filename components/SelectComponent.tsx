...
const CustomSelect: FC<SelectProps> = ({
  ...
  return (
    <div className={`${className} relative w-56 bg-pearl rounded-lg `} ref={selectRef}>
      <div
        className="px-[26px] py-[17px] md:py-[22px] text-silver rounded-lg cursor-pointer text-center"
      ...
      <Image
        ...
        alt="Arrow"
        width={14}
        className={`absolute top-1/2 -translate-y-1/2 transition-transform z-10${
