...
import Background from "@/images/legal-page/bg-vector.svg";
...
const LegalSection = () => {
  return (
    <section className="relative bg-pearl flex justify-center items-center">
      <div className="bg-darkSilver h-[500px] md:h-[700px] w-full absolute bottom-0 z-1">
        <Image
          src={Background}
          alt="Background"
      ...
      <div className="container flex flex-col items-center gap-[30px] pt-[40px] pb-[60px] xl:pb-[150px] z-10">
        ...
        <div className="flex flex-col items-center py-[40px] px-[20px] rounded-lg gap-[10px] text-center">
