      ...
      <section className="lg:bg-pearl py-[20px]">
        <div className="container relative flex flex-col items-center mt-[30px] mb-[60px] gap-[50px] lg:gap-0 lg:justify-between lg:flex-row">
          ...
          >
            {showCloud && (
              <motion.div
                className="absolute lg:left-[80%] lg:top-[-80%] xl:right-[-230%] xl:top-[-70%] bg-white text-darkBlack p-3 rounded-lg shadow-lg w-[250px]"
        ...
        {isMobile && showButton && (
          <div className="fixed bottom-3 right-3 z-10">
            ...
            >
              {showCloud && (
                <motion.div
                  className="absolute left-[-370%] border bottom-10 md:bottom-[70%] bg-white text-darkBlack p-2 rounded-lg shadow-lg w-[185px] md:w-[240px]"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, ease: "easeOut" }}
                >
